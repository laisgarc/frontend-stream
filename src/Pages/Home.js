							...
							<Grid fluid className="pt-4">
								<Row center="xs">
									<Col className="w-5/12 p-2 border border-gray-200 rounded-xl mx-2">
										<Form.Label className="text-white">Mostrar pontos ou série</Form.Label>
										<Form.Control
											...
											<option value="series">Progresso na série</option>
										</Form.Control>
									</Col>
									<Col className="w-5/12 p-2 border border-gray-200 rounded-xl mx-2">
								...
								<Row center="xs" className="my-4">
									<Col className="w-5/12 p-2 border border-gray-200 rounded-xl mx-2 items-center">
										<Form.Label className="text-white">Configuração da série</Form.Label>
										<Form.Control
											value={state_bestOf}
